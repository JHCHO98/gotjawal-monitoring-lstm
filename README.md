...
🛠 Tech Stack
Data: Google Earth Engine (GEE), Sentinel-2 Satellite Imagery

Model: ConvLSTM (PyTorch / TensorFlow)

Language: Python

Libraries: ee, geemap, geopandas, numpy, pandas, matplotlib

GIS: 국토정보플랫폼 수치지형도 (SHP)
